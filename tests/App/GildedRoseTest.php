...
class GildedRoseTest extends TestCase
{
    ...
    {
        $gildedRose = GildedRose::of(...$this->makeItem(4, 11, 'Backstage passes to a TAFKAL80ETC concert'));
        $gildedRose->tick();
        self::assertEquals(5, $gildedRose->item()->getQuality());
        $gildedRose->tick();
        self::assertEquals(7, $gildedRose->item()->getQuality());

        $gildedRose = GildedRose::of(...$this->makeItem(4, 5, 'Backstage passes to a TAFKAL80ETC concert'));
        $gildedRose->tick();
        self::assertEquals(7, $gildedRose->item()->getQuality());

        $gildedRose = GildedRose::of(...$this->makeItem(4, 0, 'Backstage passes to a TAFKAL80ETC concert'));
        $gildedRose->tick();
        self::assertEquals(0, $gildedRose->item()->getQuality());
    }
    ...
    {
        $gildedRose = GildedRose::of(...$this->makeItem(50, 1, 'Aged Brie'));
        $gildedRose->tick();
        self::assertEquals(50, $gildedRose->item()->getQuality());
    }
    ...
    {
        $gildedRose = GildedRose::of(...$this->makeItem(80,5, 'Sulfuras, Hand of Ragnaros'));
        $gildedRose->tick();
    ...
    {
        $gildedRose = GildedRose::of(...$this->makeItem(1, 1, 'Backstage passes to a TAFKAL80ETC concert'));
        $gildedRose->tick();
